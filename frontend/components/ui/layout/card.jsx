  ...
  "rounded-xl border text-card-foreground transition-all duration-300",
  {
    variants: {
      variant: {
        ...
        interactive: "bg-card border-border hover:border-primary/30 hover:shadow-glow-sm cursor-pointer",
        glow: "bg-card border-border hover:border-primary/50 hover:shadow-glow",
      },
    },
    defaultVariants: {
      variant: "default",
